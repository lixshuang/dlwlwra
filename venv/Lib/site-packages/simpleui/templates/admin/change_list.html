...
{% block extrastyle %}
    {{ block.super }}
    <link rel="stylesheet" type="text/css" href="{% static "/static/admin/css/changelists.css" %}?_=20180905"/>
    <link rel="stylesheet" type="text/css" href="{% static "/static/admin/simpleui/layui/css/layui.css" %}"/>
    {% if cl.formset %}
                ...
                {% block result_list %}
                    ...
                    {% elif actions_on_top %}
                        {% if has_add_permission %}
                            ...
                            <a style="color: white;text-decoration: none" href="{% add_preserved_filters add_url is_popup to_field %}"
