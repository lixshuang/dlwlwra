...
<div class="related-widget-wrapper">
    ...
    {% block links %}
        ...
        <a class="related-widget-wrapper-link change-related" id="change_id_{{ name }}"
            ...
            <img src="{% static '/static/admin/img/icon-changelink.svg' %}" alt="{% trans 'Change' %}"/>
        </a>
        {% endif %}
        {% if can_add_related %}
        <a class="related-widget-wrapper-link add-related" id="add_id_{{ name }}"
            ...
            <img src="{% static '/static/admin/img/icon-addlink.svg' %}" alt="{% trans 'Add' %}"/>
        </a>
        {% endif %}
        ...
        <a class="related-widget-wrapper-link delete-related" id="delete_id_{{ name }}"
            ...
            <img src="{% static '/static/admin/img/icon-deletelink.svg' %}" alt="{% trans 'Delete' %}"/>
        </a>
        {% endif %}
        {% endspaceless %}
    {% endblock %}
